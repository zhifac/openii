...
public class ConfigManager
{
	...
	{	
		...
		try {
			...
			InputStream configStream = new FileInputStream(new File("harmony.config.xml"));
			...
			java.util.regex.Matcher configMatcher = configPattern.matcher(buffer);
	...
	{
		File configFile = new File("harmony.config.xml");
		File tempConfigFile = new File(configFile.getParentFile(),"harmony.config.xml.tmp");
		try {
