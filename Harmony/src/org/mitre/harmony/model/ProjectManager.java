...
public class ProjectManager implements MappingListener, MappingCellListener
{
	...
	public void mappingModified() { setSavedToRepository(false); }
	public void mappingCellAdded(MappingCell mappingCell) { setSavedToRepository(false); }
	public void mappingCellModified(MappingCell oldMappingCell, MappingCell newMappingCell) { setSavedToRepository(false); }
	public void mappingCellRemoved(MappingCell mappingCell) { setSavedToRepository(false); }
