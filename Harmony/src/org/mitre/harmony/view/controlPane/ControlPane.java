...
public class ControlPane extends JPanel
{
	...
	public ControlPane(SchemaTree tree)
	{
		// Place depth pane and progress pane
		JPanel bottomPane = new JPanel();
		bottomPane.setBorder(new EmptyBorder(1,1,1,1));
		bottomPane.setLayout(new BorderLayout());
		bottomPane.add(new SchemaTreeSearch(tree),BorderLayout.CENTER);
		bottomPane.add(new SchemaTreeFinished(tree),BorderLayout.EAST);
		...
		add(new DepthPane(tree),BorderLayout.NORTH);
