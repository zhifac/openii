package org.mitre.schemastore.porters.mappingExporters.matchmaker;
...
public class ClusterRenderer {
	...
	public ClusterRenderer(ClusterNode cluster, HarmonyModel model, Integer[] schemaIDs) {
		this.cluster = cluster;
		this.harmonyModel = model;
	...
	private void printPretty() {
		...
		for (Integer schemaId : schemaIDs) {
			...
			HierarchicalGraph hGraph = new HierarchicalGraph(harmonyModel.getSchemaManager().getGraph(schemaId), null);
