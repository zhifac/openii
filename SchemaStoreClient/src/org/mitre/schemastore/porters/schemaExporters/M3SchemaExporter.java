...
{	
	...
	public static void main(String[] args){
		...
		try {
			Repository repository = new Repository(Repository.POSTGRES,new URI("bmd.mitre.org"),"schemastore","schemastore","bmdSchemastore");
	...
	public String getMD5(Integer schemaId) throws IOException{
		...
		while(iter.hasNext()){
			...
			if (repo.getDatabaseName().equalsIgnoreCase("schemastore")){
