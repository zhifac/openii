...
public class ExtractYearTest {

    private ExtractYear add = null;
    ...
    public void setUp() {
        add = new ExtractYear();
        cell = factory.getMappingCells().get("extract");
    }
    ...
    public void testGetRelationalString() {
        assertEquals("EXTRACT(YEAR FROM \"DOB\")", add.getRelationalString(factory.getPrefixArray("", cell.getInput().length), cell, factory.getMappingDefinition()));
    }
