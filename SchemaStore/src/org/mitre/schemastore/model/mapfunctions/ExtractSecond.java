 ...
 *  @version    1.0
 */
public class ExtractSecond extends ExtractYear
{

    public ExtractSecond( )
    {
        super();
        functionName = "EXTRACT(SECOND FROM ";
        displayName = "Extract Second";
        description = "Extracts the second of the minute from a date field";
