...
public class SearchToolBar extends Composite{
	...
	List<Schema> schemas;
	AffinityPane affinityPane;
	
	public SearchToolBar(Composite parent, int style, AffinityPane ap, List<Schema> schemas){
		super(parent, style);		
		...
		searchField.addSelectionListener(new SelectionAdapter(){
			public void widgetDefaultSelected(SelectionEvent e){
				...
				for(Schema s: schemas){
					if(s.getName().equalsIgnoreCase(searchingForSchema)){
//					if(s.getName().equals(searchingForSchema)){
				...
				//	System.out.println("Not found, do nothing");
				//}
			}
		});
