...
public class RMapSchemaManager extends SchemaManager {
	...
	public HashMap<Integer,MappingSchema> _sourceSchemaIDForMappingID = null;
	public HashMap<Integer,MappingSchema> _targetSchemaIDForMappingID = null;
	...
	public void initSchemas(ArrayList<Dependency> dependList)
	{
		...
		_sourceSchemaIDForMappingID = new HashMap<Integer,MappingSchema>();
		_targetSchemaIDForMappingID = new HashMap<Integer,MappingSchema>();
		...
		try {
			...
			for (Dependency depend : dependList ){
				...
				Object[] mapInfo = depend.generateMapping();
				...
				_sourceSchemaIDForMappingID.put(mapping.getId(), mapping.getSchemas()[0]);
				_targetSchemaIDForMappingID.put(mapping.getId(), mapping.getSchemas()[1]); //new MappingSchema(targetGraph.getSchema().getId(),"RMap",MappingSchema.RIGHT));
