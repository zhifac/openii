...
import view.groupPane.groupSelectionTree.GroupSelectionTree;
import view.groupPane.groupSelectionTree.SelectedGroupsWithInferredChildren;

/** Class for displaying the Active Group Pane of Galaxy */
public class SelectGroupPane extends JPanel
{	
	...
	/** Constructs the Active Group Pane */
	public SelectGroupPane()
	{
