...
/**
 * An implementation of MDS using stress minimization by means of majorization (smacof).  Adapted from the smacof package in R, 
 * by Jan de Leeuw and Patrick Mair. Used under GPL. See http://lib.stat.cmu.edu/R/CRAN/.
 * 
 * @author CBONACETO
 *
 */
public class MalabMDS implements IMultiDimScaler {
	/**
