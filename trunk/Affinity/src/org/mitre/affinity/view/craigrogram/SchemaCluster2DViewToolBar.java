...
public class SchemaCluster2DViewToolBar extends Composite {
	/** The schema-cluster view this tool bar is tied to */
	ISchemaCluster2DView schemaCluster2DView;
	...
	public SchemaCluster2DViewToolBar(Composite parent, int style, ISchemaCluster2DView schemaClusterView) {
		super(parent, style);		
	...
	private void creatToolBar() {
		...
		selectItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				schemaCluster2DView.setMode(Mode.SELECT_MULTIPLE_SCHEMAS);
			}
		});
		...
		textSizeCombo.addSelectionListener(new SelectionAdapter() {			
			public void widgetSelected(SelectionEvent e) {				
				if(textSizeCombo.getSelectionIndex() != -1) {
					...
					case 0: 
						schemaCluster2DView.setSchemaNamesVisible(true);
					...
					case 2: 
						...
						break;
					case 3: 
						schemaCluster2DView.setSchemaNamesVisible(false);
						schemaCluster2DView.redraw();
						break;
					}
				}
