...
public class ClusterDetailsDlg {
	private final AffinityModel affinityModel;
	...
	// Dialog components
	private ClusterDetailsPane clusterDetailsPane;
	
	public ClusterDetailsDlg(Composite parent, int style, AffinityModel affinityModel, ClusterGroup cluster) {
		this.parent = parent;
		this.style = style;
	...
	private void createDialogShell() {
		...
		this.clusterDetailsPane = new ClusterDetailsPane(dialogShell, SWT.NONE, affinityModel, cluster);
