package org.mitre.openii.views.manager.dialogs;
...
public class URIField implements ModifyListener
{
	...
	public URIField(Composite parent, SelectionListener listener)
	{
		...
		uriLabel = DialogComponents.createLabel(parent, "File");
	...
	public void setMode(Integer mode)
	{
		...
		if(mode.equals(FILE) && uriButton==null)
			{ uriButton = DialogComponents.createButton(uriPane, "Get File...", listener); }
