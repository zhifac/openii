...
column_def: name=id_column_def { builder.addAttributeToLastEntity( name.getTree().toString() ); } type_name?  column_constraint*
...
column_constraint_not_for_replication: NOT FOR REPLICATION table_conflict_clause?;

column_constraint_null: NULL table_conflict_clause?;
