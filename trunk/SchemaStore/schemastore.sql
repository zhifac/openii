...
48	DOB	The organism's date of birth	20	-4
52	VisitDate	The date associated with a particular diagnosis	21	-4
53	Diagnosis	The organism's health status on a particular date	21	-3
54	Start	The date the protocol started	23	-4
55	Stop	The projected or actual stop date	23	-4
56	Funding	The name of the agency funding the protocol	23	-3
57	GrantNum	The grant identifier provided by the funding agency	23	-1
58	MeasurementDate	Date on which the measurements were acquired	22	-4
59	Ht	The organism's height (in inches)	22	-1
60	Wt	The organism's weight (in pounds)	22	-1
64	Hglb	Hemoglobin count	22	-1
65	TotProt	Total protein count	22	-1
66	Alb	Albumin count	22	-1
67	hdl	Indicates the measured high-density lipids	22	-1
68	ldl	Indicates the measured low-density lipids	22	-1
69	XRes	X-resolution	24	-2
70	YRes	Y-resolution	24	-2
71	ZRes	Z-resolution	24	-2
47	Species	The species of the test organism	20	81
49	Gender	The organism's gender	20	83
50	ConsentStatus	Indicates the subject's willingness to be contacted	20	84
51	Race	Indicates a human subject's race/ethnicity	20	85
61	VerbalMemory	Stores the subject's score on a verbal memory test	22	95
62	VisualMemory	Stores the subject's score on a visual memory test	22	95
63	Handedness	Stores the subject's observed handedness	22	97
72	Modality	Modality	24	106
73	PrimaryLanguage	NULL	22	107
\.
...
COPY "schema" (id, name, author, source, type, description, "committed") FROM stdin;
